// src/modules/admin/pages/Assignments/index.jsx
...
const Assignments = () => {
  ...
  return (
    <FadeIn>
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              ...
              {assignments.length > 0 && <span className="ml-2 text-blue-600 font-medium">· {assignments.length} total assignments</span>}
            </p>
          </div>
          <div className="flex items-center gap-3">
            <Button variant="outline" className="border-gray-200" onClick={fetchAssignments} disabled={loading}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <Card className="p-4 border-l-4 border-l-blue-500">
            ...
            <p className="text-xs text-gray-400 mt-1">All assignments</p>
          </Card>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  <th className="text-left px-4 py-3.5 text-xs font-semibold text-gray-600 uppercase tracking-wider">Assignment</th>
                  ...
                  <th className="text-left px-4 py-3.5 text-xs font-semibold text-gray-600 uppercase tracking-wider">Submissions</th>
      ...
      {/* Assignment Detail Modal - Modern Professional */}
      {detailModalOpen && selectedAssignment && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative px-6 py-6 bg-gradient-to-r from-blue-600 to-purple-600 rounded-t-2xl">
              ...
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white text-3xl font-bold shadow-lg">
                  {selectedAssignment.title?.charAt(0).toUpperCase() || "A"}
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <Badge className={selectedAssignment.status === "active" ? "bg-green-500/30 text-white border-green-400/30 text-xs" : 
                                    selectedAssignment.status === "pending" ? "bg-yellow-500/30 text-white border-yellow-400/30 text-xs" :
                                    selectedAssignment.status === "completed" ? "bg-blue-500/30 text-white border-blue-400/30 text-xs" :
                                    "bg-red-500/30 text-white border-red-400/30 text-xs"}>
                      {STATUS_ICONS[selectedAssignment.status]}
                      {STATUS_LABELS[selectedAssignment.status] || selectedAssignment.status || "Unknown"}
                    </Badge>
                  </div>
                </div>
              </div>
            ...
            <div className="p-6 space-y-5">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <p className={`text-sm font-semibold ${selectedAssignment.status === "overdue" ? "text-red-600" : "text-gray-800"}`}>
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                ...
                <p className="text-2xl font-bold text-gray-800">
                  ...
                  <span className="text-sm font-normal text-gray-500 ml-2">submissions</span>
                </p>
              </div>
      ...
      {deletingAssignment && (
        <ConfirmDialog
          ...
          message={`This permanently removes "${deletingAssignment.title}" and all associated data. This action cannot be undone.`}
