                      ...
                      <td className="px-4 py-3.5">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <p className="font-medium text-gray-800 text-sm truncate">{exam.name || "—"}</p>
                            {exam.total_marks && (
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="p-4 border-l-4 border-l-green-500">
          ...
          <p className="text-2xl font-bold text-green-600">{stats.highestGrade?.grade || "—"}</p>
        ...
        <Card className="p-4 border-l-4 border-l-red-500">
          ...
          <p className="text-2xl font-bold text-red-600">{stats.lowestGrade?.grade || "—"}</p>
          <p className="text-xs text-gray-400 mt-1">
      ...
      <Card className="p-0 overflow-hidden shadow-sm border border-gray-100">
        <div className="p-4 sm:p-6 border-b border-gray-100 bg-gray-50/60">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button
              className="bg-blue-600 hover:bg-blue-700 text-white whitespace-nowrap shadow-lg shadow-blue-600/20"
      ...
      <Card className="p-0 overflow-hidden shadow-sm border border-gray-100">
        <div className="p-4 sm:p-6 border-b border-gray-100 bg-gray-50/60">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button              className="bg-blue-600 hover:bg-blue-700 text-white whitespace-nowrap shadow-lg shadow-blue-600/20"
                  ...
                  >
                    ...
                    <td className="px-4 py-3.5 text-right" onClick={(e) => e.stopPropagation()}>
                      <div className="flex items-center justify-end gap-0.5 opacity-60 group-hover:opacity-100 transition-opacity">
                        ...
                        <button
                          onClick={() => setDeletingItem(answer)}
                          className="p-2 rounded-lg hover:bg-red-50 text-red-600 transition-colors"
                          title="Delete answer"
                        >
                          <Trash2 className="w-4 h-4" />
...
const Exams = () => {
  ...
  const getActiveTabData = () => {
    switch(activeTab) {
      case "exams": return { data: exams, loading: loadingExams, error: examsError, errorMessage: examsErrorMessage };
      case "grade-scale": return { data: grades, loading: loadingGrades, error: gradesError, errorMessage: gradesErrorMessage };
      case "questions": return { data: questions, loading: loadingQuestions, error: questionsError, errorMessage: questionsErrorMessage };
      case "student-answers": return { data: studentAnswers, loading: loadingAnswers, error: answersError, errorMessage: answersErrorMessage };
      case "ai-auto-checking": return { data: aiChecks, loading: loadingAiChecks, error: aiChecksError, errorMessage: aiChecksErrorMessage };
      default: return { data: [], loading: false, error: false, errorMessage: "" };
    }
  };
