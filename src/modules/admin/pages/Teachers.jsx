// src/modules/admin/pages/Teachers.jsx
import React, { useState, useCallback } from "react";
import { 
  Search, Plus, Edit, Trash2, Phone, Mail, Calendar, 
  Users, X, RefreshCw, AlertCircle, CheckCircle, 
...
const Teachers = () => {
  ...
  }, [editingTeacher, update, create, showToast]);
  ...
  }, [deletingTeacher, remove, showToast]);
      ...
      <FadeIn>
        <div className="space-y-6 md:space-y-8 px-4 sm:px-6 md:px-8">
          ...
          <div className="flex flex-col items-center justify-center h-64 md:h-96">
            ...
            <p className="mt-4 md:mt-6 text-sm text-gray-500 font-medium">Loading teachers...</p>
          </div>
        </div>
      </FadeIn>
    );
  ...
  return (
    <FadeIn>
      <div className="space-y-6 md:space-y-8 px-4 sm:px-6 md:px-8">
        <PageHeader 
          title="Teachers" 
          subtitle={`Manage all teachers${records.length ? ` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â ${records.length} total` : ""}`}
          breadcrumbs={["Admin", "Teachers"]}
          icon={GraduationCap}
          action={
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          <Card className="p-3 md:p-4 border-l-4 border-l-blue-500">
            <p className="text-[10px] md:text-xs font-medium text-gray-500 uppercase tracking-wider">Total Teachers</p>
            <p className="text-xl md:text-2xl font-bold text-gray-800">{stats.total}</p>
            <p className="text-[10px] md:text-xs text-gray-400 mt-0.5 md:mt-1">All teachers</p>
          </Card>
          ...
          <Card className="p-3 md:p-4 border-l-4 border-l-purple-500">
            <p className="text-[10px] md:text-xs font-medium text-gray-500 uppercase tracking-wider">Specializations</p>
            <p className="text-xl md:text-2xl font-bold text-purple-600">
              {new Set(records.map(s => s.subject_specialization).filter(Boolean)).size}
            </p>
            <p className="text-[10px] md:text-xs text-gray-400 mt-0.5 md:mt-1">Unique specializations</p>
          </Card>
        </div>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 shrink-0 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white text-sm font-semibold shadow-sm">
                                {getInitials(teacher.name)}
                              </div>
                              <div className="min-w-0 flex-1">
                                <p className="font-semibold text-gray-900 text-sm truncate">{teacher.name || "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â"}</p>
                                <p className="text-xs text-gray-500 truncate">{teacher.email || "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â"}</p>
                              </div>
                            </div>
                            <div className="flex flex-wrap items-center gap-1.5 mt-2">
                              ...
                              <Badge className={`${STATUS_BADGE[teacher.status] || "bg-gray-50 text-gray-600 border-gray-200"} text-[10px] flex items-center gap-1`}>
                                <span>{STATUS_ICON[teacher.status] || "ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢"}</span>
                                {teacher.status ? teacher.status.charAt(0).toUpperCase() + teacher.status.slice(1) : "Unknown"}
                              </Badge>
                            </div>
                            {teacher.qualification && (
                              <p className="text-xs text-gray-500 mt-1.5 truncate">{teacher.qualification}</p>
                            )}
                          </div>
                        ...
                        >
                          <td className="px-4 py-3.5">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="min-w-0">
                                <p className="font-semibold text-gray-900 text-sm truncate max-w-[150px]">{teacher.name || "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â"}</p>
                                <p className="text-xs text-gray-500 truncate max-w-[150px]">{teacher.email || "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â"}</p>
                              </div>
                            </div>
                          </td>
                          <td className="px-4 py-3.5">
                          ...
                          <td className="px-4 py-3.5">
                            <span className="text-sm text-gray-700 truncate max-w-[120px] block">
                              {teacher.qualification || "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â"}
                            </span>
                          </td>
                          <td className="px-4 py-3.5">
                            <Badge className={`${STATUS_BADGE[teacher.status] || "bg-gray-50 text-gray-600 border-gray-200"} text-xs flex items-center gap-1.5 px-2.5 py-1 whitespace-nowrap`}>
                              <span>{STATUS_ICON[teacher.status] || "ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢"}</span>
                              {teacher.status ? teacher.status.charAt(0).toUpperCase() + teacher.status.slice(1) : "Unknown"}
                            </Badge>
                          </td>
