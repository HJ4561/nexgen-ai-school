// src/modules/admin/pages/FeeManagement.jsx
      ...
      <FadeIn>
        <div className="space-y-6 px-4 sm:px-6 lg:px-8">
          <PageHeader 
            ...
            subtitle="Manage student fees and track payments" 
  ...
  return (
    <FadeIn>
      <div className="space-y-6 px-4 sm:px-6 lg:px-8">
        ...
        <PageHeader 
          title="Fee Management" 
          subtitle={`Manage student fees and track payments${fees.length > 0 ? ` Ã¢â‚¬â€ ${fees.length} total fees` : ""}`}
          breadcrumbs={["Admin", "Finance", "Fee Management"]}
          action={
                      ...
                      <td className="px-4 py-3.5 align-middle">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`text-sm ${fee.isOverdue ? "text-red-600 font-medium" : "text-gray-600"}`}>
                            {fee.due_date ? new Date(fee.due_date).toLocaleDateString() : "Ã¢â‚¬â€"}
                          </span>
