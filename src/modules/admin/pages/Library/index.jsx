// src/modules/admin/pages/Library/index.jsx
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-4">
          <div><label className="block text-sm font-medium text-gray-600 mb-1">Title <span className="text-red-500">*</span></label>
          ...
          <div><label className="block text-sm font-medium text-gray-600 mb-1">Author <span className="text-red-500">*</span></label>
          ...
          <div><label className="block text-sm font-medium text-gray-600 mb-1">ISBN</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div><label className="block text-sm font-medium text-gray-600 mb-1">Total Copies <span className="text-red-500">*</span></label>
            ...
            <div><label className="block text-sm font-medium text-gray-600 mb-1">Available Copies</label>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex justify-end gap-2 bg-gray-50/50 rounded-b-2xl">
          ...
          <button onClick={onSave} disabled={loading || !formData.title || !formData.author || !formData.total_copies} className="px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl hover:from-blue-700 hover:to-blue-800 shadow-md shadow-blue-600/25 transition-all disabled:opacity-50 flex items-center gap-2">
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="space-y-4">
          <div><label className="block text-sm font-medium text-gray-600 mb-1">Student ID <span className="text-red-500">*</span></label>
          ...
          <div><label className="block text-sm font-medium text-gray-600 mb-1">Due Date <span className="text-red-500">*</span></label>
        ...
        <div className="flex gap-2 mt-6 pt-4 border-t border-gray-100">
          ...
          <button onClick={onIssue} disabled={loading || !formData.student || !formData.due_date} className="flex-1 px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl hover:from-blue-700 hover:to-blue-800 shadow-md shadow-blue-600/25 transition-all disabled:opacity-50 flex items-center justify-center gap-2">
    ...
    <FadeIn>
      <div className="space-y-8">
        <PageHeader 
          ...
          subtitle={`Manage books, issues, and history${books.length > 0 ? ` — ${books.length} books` : ""}`}
          ...
          action={
            <div className="flex items-center gap-2.5">
              ...
              <button
                onClick={() => {
                  if (activeTab === "books") { setBookModalMode("add"); setBookFormData({ title: "", author: "", category: "", isbn: "", total_copies: "", available_copies: "", description: "" }); setBookModalOpen(true); }
                }}
              ...
              >
                ...
                {activeTab === "books" ? "Add Book" : activeTab === "issues" ? "No Action" : "No Action"}
              </button>
            </div>
          }
        />
                    ...
                    if (activeTab === "books") {
                      ...
                      return (
                        <tr key={item.id} className="hover:bg-blue-50/30 transition-colors duration-150 group">
                          <td className="px-4 py-3.5"><div className="flex items-center gap-3"><div className="w-8 h-8 rounded-lg bg-amber-50 flex items-center justify-center"><Book className="w-4 h-4 text-amber-600" /></div><span className="font-medium text-gray-900">{item.title || "—"}</span></div></td>
                          <td className="px-4 py-3.5 text-gray-700">{item.author || "—"}</td>
                          ...
                          <td className="px-4 py-3.5 text-gray-700 font-mono text-xs">{item.isbn || "—"}</td>
                      ...
                      return (
                        <tr key={item.id} className="hover:bg-blue-50/30 transition-colors duration-150 group">
                          <td className="px-4 py-3.5"><div className="flex items-center gap-3"><div className="w-8 h-8 rounded-lg bg-amber-50 flex items-center justify-center"><Book className="w-4 h-4 text-amber-600" /></div><span className="font-medium text-gray-900">{getBookTitle(item.book)}</span></div></td>
                          <td className="px-4 py-3.5 text-sm text-gray-600">{item.student || "—"}</td>
                          <td className="px-4 py-3.5"><div className="flex items-center gap-1.5"><Calendar className="w-3.5 h-3.5 text-gray-400" /><span className={`text-sm ${isOverdue(item) && item.status !== "returned" ? "text-red-600 font-medium" : "text-gray-600"}`}>{formatDate(item.due_date)}</span></div></td>
                      ...
                      return (
                        <tr key={item.id} className="hover:bg-blue-50/30 transition-colors duration-150 group">
                          <td className="px-4 py-3.5 font-medium text-gray-900">{item.book?.title || getBookTitle(item.book_issue) || "—"}</td>
                          <td className="px-4 py-3.5 text-sm text-gray-600">{item.student?.name || "—"}</td>
                          <td className="px-4 py-3.5"><div className="flex items-center gap-2"><Badge className="bg-gray-50 text-gray-700 border-gray-200 text-xs">{STATUS_LABELS[item.status_old] || item.status_old || "—"}</Badge><ArrowRight className="w-3 h-3 text-gray-400" /><Badge className={`${STATUS_COLORS[item.status_new] || "bg-gray-50 text-gray-700 border-gray-200"} text-xs`}>{STATUS_LABELS[item.status_new] || item.status_new || "—"}</Badge></div></td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-4">
              {selectedBook && (
                <div className="grid grid-cols-2 gap-4">
                  <div><p className="text-xs text-gray-500">Title</p><p className="font-medium text-gray-800">{selectedBook.title || "—"}</p></div>
                  <div><p className="text-xs text-gray-500">Author</p><p className="font-medium text-gray-800">{selectedBook.author || "—"}</p></div>
                  ...
                  <div><p className="text-xs text-gray-500">ISBN</p><p className="font-medium text-gray-800 font-mono">{selectedBook.isbn || "—"}</p></div>
                  ...
                  <div className="col-span-2"><p className="text-xs text-gray-500">Description</p><p className="text-gray-600">{selectedBook.description || "—"}</p></div>
                </div>
              )}
              {selectedIssue && (
                <div className="grid grid-cols-2 gap-4">
                  <div><p className="text-xs text-gray-500">Book</p><p className="font-medium text-gray-800">{getBookTitle(selectedIssue.book)}</p></div>
                  <div><p className="text-xs text-gray-500">Student</p><p className="font-medium text-gray-800">{selectedIssue.student || "—"}</p></div>
            ...
            <div className="px-6 py-4 border-t border-gray-100 flex justify-end bg-gray-50/50 rounded-b-2xl">
              <button onClick={() => { setDetailsModalOpen(false); setSelectedBook(null); setSelectedIssue(null); }} className="px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all">Close</button>
            </div>
          </div>
        </div>
      )}
      ...
      {historyModalOpen && selectedHistory && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div><p className="text-xs text-gray-500">Book</p><p className="font-medium text-gray-800 mt-1">{selectedHistory.book?.title || getBookTitle(selectedHistory.book_issue) || "—"}</p></div>
                <div><p className="text-xs text-gray-500">Student</p><p className="font-medium text-gray-800 mt-1">{selectedHistory.student?.name || "—"}</p></div>
                <div><p className="text-xs text-gray-500">Old Status</p><Badge className="bg-gray-50 text-gray-700 border-gray-200 mt-1">{STATUS_LABELS[selectedHistory.status_old] || selectedHistory.status_old || "—"}</Badge></div>
                <div><p className="text-xs text-gray-500">New Status</p><Badge className={`${STATUS_COLORS[selectedHistory.status_new] || "bg-gray-50 text-gray-700 border-gray-200"} mt-1`}>{STATUS_LABELS[selectedHistory.status_new] || selectedHistory.status_new || "—"}</Badge></div>
                ...
                <div className="col-span-2"><p className="text-xs text-gray-500">Reason</p><p className="text-gray-600 mt-1">{selectedHistory.reason || "—"}</p></div>
              </div>
            </div>
            <div className="px-6 py-4 border-t border-gray-100 flex justify-end bg-gray-50/50 rounded-b-2xl">
              <button onClick={() => { setHistoryModalOpen(false); setSelectedHistory(null); }} className="px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all">Close</button>
            </div>
          </div>
        </div>
      )}
