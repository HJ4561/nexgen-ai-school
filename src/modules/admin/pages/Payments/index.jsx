// src/modules/admin/pages/Payments/index.jsx
...
const MethodBadge = ({ method }) => {
  if (!method) return <Badge className="bg-gray-100 text-gray-700 text-xs">—</Badge>;
  return (
...
const StatusBadge = ({ status }) => {
  if (!status) return <Badge className="bg-gray-100 text-gray-700 text-xs">—</Badge>;
  return (
  ...
  return (
    <FadeIn>
      <div className="space-y-6">
        ...
        <PageHeader 
          title="Payments" 
          subtitle={`Track and manage all payment transactions across the school${payments.length > 0 ? ` — ${payments.length} total payments` : ""}`}
        ...
        <Card className="p-0 overflow-hidden shadow-sm border border-gray-100">
          ...
          <div className="p-4 sm:p-6 border-b border-gray-100 bg-gray-50/60">
            ...
            {selectedIds.size > 0 && (
              <div className="flex items-center justify-between bg-blue-50 border border-blue-100 rounded-xl px-4 py-2.5 mt-4">
                ...
                {loading ? (
                  Array.from({ length: 5 }).map((_, i) => (
                    <tr key={i} className="animate-pulse">
                      ...
                      <td className="px-4 py-3.5"><div className="h-6 w-20 bg-gray-100 rounded-full" /></td>
