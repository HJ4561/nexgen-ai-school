...
import { 
  ...
  Clock, CheckCircle, MessageSquare, Users, Bell, Menu
} from "lucide-react";
...
// ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Stats Cards Component ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
      ...
      <Card className="p-3 md:p-4 border-l-4 border-l-amber-500">
        ...
        <p className="text-xl md:text-2xl font-bold text-amber-600">{stats.upcoming}</p>
      ...
      <Card className="p-3 md:p-4 border-l-4 border-l-purple-500">
        ...
        <p className="text-xl md:text-2xl font-bold text-purple-600">{stats.highPriority}</p>
...
const Announcements = () => {
  ...
  const getStatus = useCallback((announcement) => {
  ...
  const filteredAnnouncements = useMemo(() => {
    ...
    return filtered;
  }, [announcements, searchTerm, filterPriority, filterStatus, getStatus]);
  ...
  const handleAddAnnouncement = async () => {
    if (!formData.name.trim() || !formData.description.trim() || !formData.event_date) {
    ...
    try {
      const payload = {
        ...
        location: formData.location?.trim() || "School",
      ...
      <FadeIn>
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="flex flex-col items-center justify-center h-64 md:h-96">
            ...
            <p className="mt-4 md:mt-6 text-sm text-gray-500 font-medium">Loading announcements...</p>
          </div>
        </div>
      </FadeIn>
    );
  ...
  return (
    <FadeIn>
      <div className="space-y-6 md:space-y-8">
        <PageHeader 
          title="Announcements" 
          subtitle={`Manage school announcements${announcements.length > 0 ? ` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â ${announcements.length} total` : ""}`}
          breadcrumbs={["Admin", "Announcements"]}
          action={
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={refreshing}
                className="hidden sm:inline-flex items-center gap-2 px-3 md:px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all disabled:opacity-50"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 md:px-5 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl hover:from-blue-700 hover:to-blue-800 shadow-md shadow-blue-600/25 hover:shadow-lg hover:shadow-blue-600/35 transition-all duration-200"
              >
        ...
        <Card className="p-0 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="p-3 md:p-4 border-b border-gray-100 bg-gray-50/60">
            <div className="flex flex-col gap-3">
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="sm:hidden px-4 py-2.5 text-sm font-medium text-gray-600 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center gap-2"
                >
              ...
              <div className={`flex flex-col sm:flex-row gap-2 ${!showFilters && 'hidden sm:flex'}`}>
                <select
                  ...
                  className="w-full sm:w-auto px-3 md:px-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all text-sm"
                >
                ...
                <button
                  onClick={() => setShowFilters(!showFilters)}
                  className="hidden sm:flex px-4 py-2.5 text-sm font-medium text-gray-600 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all items-center gap-2"
                >
                  <Filter className="w-4 h-4" />
                  Filters
                  <ChevronDown className={`w-3 h-3 transition-transform ${showFilters ? "rotate-180" : ""}`} />
                ...
                {hasActiveFilters && (
                  <button
                    ...
                    className="w-full sm:w-auto px-4 py-2.5 text-sm font-medium text-gray-500 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center gap-1"
                  >
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div>
                    <p className="text-gray-500 font-medium text-base">
                      {searchTerm || hasActiveFilters ? "No announcements match" : "No announcements found"}
                    </p>
                  ...
                  {!searchTerm && !hasActiveFilters && (
                    <button
                      onClick={() => setModalOpen(true)}
                      className="mt-2 inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl hover:from-blue-700 hover:to-blue-800 shadow-md shadow-blue-600/25 transition-all duration-200"
                    >
                      <Plus className="w-4 h-4" />
                      Add Announcement
                    </button>
              ...
              <div className="divide-y divide-gray-100">
                {pageItems.map((announcement) => {
                  ...
                  return (
                    <div 
                      key={announcement.id} 
                      className={`p-4 hover:bg-blue-50/30 transition-colors ${status === "active" ? "bg-blue-50/10" : ""}`}
                    >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <h4 className="font-medium text-gray-900 text-sm truncate">
                              {announcement.name || "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â"}
                            </h4>
                          </div>
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-3">
                        ...
                        <Badge className={`${getPriorityBadge(priority)} text-xs flex items-center gap-1 px-2 py-0.5`}>
                          {getPriorityIcon(priority)}
                          {getPriorityLabel(priority)}
                        </Badge>
                        <Badge className={`${getStatusBadge(status)} text-xs px-2 py-0.5`}>
                  ...
                  {pageItems.map((announcement) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3.5">
                          <Badge className={`${getPriorityBadge(priority)} text-xs flex items-center gap-1.5 px-2.5 py-1 w-fit`}>
                            {getPriorityIcon(priority)}
                            {getPriorityLabel(priority)}
                          </Badge>
                        </td>
                        <td className="px-4 py-3.5">
                          <Badge className={`${getStatusBadge(status)} text-xs px-2.5 py-1 w-fit`}>
                            {status.charAt(0).toUpperCase() + status.slice(1)}
                          </Badge>
                        </td>
                        <td className="px-4 py-3.5">
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between px-4 md:px-6 py-4 border-b border-gray-100 sticky top-0 bg-white rounded-t-2xl">
              <h3 className="font-semibold text-gray-800 text-base md:text-lg">Add Announcement</h3>
              <button
            ...
            <div className="px-4 md:px-6 py-4 border-t border-gray-100 flex flex-col sm:flex-row justify-end gap-2 bg-gray-50/50 rounded-b-2xl">
              <button
                onClick={() => setModalOpen(false)}
                disabled={saving}
                className="w-full sm:w-auto px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all disabled:opacity-50 order-2 sm:order-1"
              >
                Cancel
              </button>
              <button
                ...
                disabled={saving}
                className="w-full sm:w-auto px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl hover:from-blue-700 hover:to-blue-800 shadow-md shadow-blue-600/25 transition-all disabled:opacity-50 flex items-center justify-center gap-2 order-1 sm:order-2"
              >
                {saving ? (
      ...
      {detailModalOpen && selectedAnnouncement && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between px-4 md:px-6 py-4 border-b border-gray-100 sticky top-0 bg-white rounded-t-2xl">
              <h3 className="font-semibold text-gray-800 text-base md:text-lg">Announcement Details</h3>
              <button
            ...
            <div className="p-4 md:p-6 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <p className="font-medium text-gray-800 break-words">{selectedAnnouncement.name || "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â"}</p>
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-medium text-gray-800">{selectedAnnouncement.location || "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â"}</p>
                </div>
                <div className="col-span-1 sm:col-span-2 space-y-1">
                  <p className="text-xs text-gray-500">Description</p>
                  <div className="text-gray-700 bg-gray-50 p-4 rounded-xl border border-gray-100 break-words">
                    {selectedAnnouncement.description || "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â"}
                  </div>
                </div>
              </div>
            </div>

            <div className="px-4 md:px-6 py-4 border-t border-gray-100 flex justify-end bg-gray-50/50 rounded-b-2xl">
              <button
                onClick={() => setDetailModalOpen(false)}
                className="w-full sm:w-auto px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all"
              >
                Close
              </button>
            </div>
      ...
      {/* Toast */}
      {toast && (
        <div className={`fixed bottom-4 md:bottom-6 left-4 right-4 md:left-auto md:right-6 z-50 ${toast.type === "success" ? "bg-emerald-600" : toast.type === "error" ? "bg-red-600" : "bg-blue-600"} text-white text-sm px-4 md:px-5 py-3 rounded-xl shadow-xl animate-in slide-in-from-bottom-4 duration-300 flex items-center gap-2 max-w-full md:max-w-md`}>
