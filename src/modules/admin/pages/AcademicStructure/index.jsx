// // src/modules/admin/pages/AcademicStructure/index.jsx
...
//                 <Card className={`p-6 border-l-4 ${colorClasses[module.color]} transition-all hover:shadow-lg hover:-translate-y-1 cursor-pointer`}>
//                   <div className="flex items-start justify-between">
//                     <div>
//                       <div className={`p-3 rounded-xl bg-white ${iconColors[module.color]}`}>
//                         <Icon className="w-6 h-6" />
//                       </div>
//                       <h3 className="text-lg font-semibold text-gray-800 mt-4">{module.title}</h3>
//                       <p className="text-sm text-gray-500">{module.description}</p>
//                     </div>
//                     <span className="text-2xl font-bold text-gray-700">{module.count}</span>
//                   </div>
//                 </Card>
//               </Link>
//             );
